...
#
# Time-stamp: <2023/04/27 18:38:52 (CST) daisuke>
#
...
desc   = 'generating a synthetic FITS image of sky background and stars'
...
# generating stars
stars = photutils.datasets.make_gaussian_prf_sources_image (image_size, \
                                                            source_table)
...
# printing status
print (f'# now, making synthetic image data...')

# synthetic image of sky background + stars
data = skybg + stars

# printing status
print (f'# finished making synthetic image data!')
print (f'#')
