...
#
# Time-stamp: <2023/03/16 18:12:29 (CST) daisuke>
#
...
desc   = 'Calculating statistical values of pixel data of multiple images'
parser = argparse.ArgumentParser (description=desc)

# adding arguments
parser.add_argument ('files', nargs='+', help='names of FITS files')
