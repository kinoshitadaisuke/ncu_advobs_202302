...
#
# Time-stamp: <2023/03/23 20:37:22 (CST) daisuke>
#
...
desc   = 'Existence check of keyword "JD" in a FITS file'
...
# existence check of a keyword "JD"
existence_jd = 'JD' in header0

# printing result of existence check
print (f'keyword "JD" exists in "{file_fits}"? ==> {existence_jd}')
