...
parser.add_argument ('-a', type=float, default=0.0, \
                     help='minimum intensity to display (default: 0)')
parser.add_argument ('-b', type=float, default=65535.0, \
                     help='maximum intensity to display (default: 65535)')
...
# plotting image
im = ax.imshow (data0, origin='lower', cmap=cmap, vmin=z1, vmax=z2)
fig.colorbar (im)
