...
#
# Time-stamp: <2023/03/09 11:21:32 (CST) daisuke>
#
...
# calculation of kurtosis using fourth moment and standard deviation
kurtosis2 = moment_4 * stddev**-4

# calculation of kurtosis of Fisher's definition
kurtosis2_ex = kurtosis2 - 3.0
...
print (f'  skewness2     = {skew2:10.4f}')
print (f'  kurtosis      = {kurtosis:10.4f}')
print (f'  kurtosis_ex   = {kurtosis_ex:10.4f}')
print (f'  kurtosis2     = {kurtosis2:10.4f}')
print (f'  kurtosis2_ex  = {kurtosis2_ex:10.4f}')
