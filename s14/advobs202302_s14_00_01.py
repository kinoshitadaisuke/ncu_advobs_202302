...
#
# Time-stamp: <2023/05/11 16:21:20 (CST) daisuke>
#
...
# printing header
print (f"# star ID, RA, Dec, r'-band mag.")

# processing catalogue files one-by-one
